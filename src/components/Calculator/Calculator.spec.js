...
describe('callOperator', () => {
  ...
  it('updates displayValue to the "0" if operation results in NaN', () => {
    wrapper.setState({storedValue: '3'});
  ...
  it('updates displayValue to the "0" if operation results in Infinity', () => {
  ...
  it('updates displayValue to the "0" if selectedOperator does not match cases', () => {
    wrapper.setState({storedValue: '7'});
  ...
  it('updates displayValue to the "0" if called with no value for storedValue or selectedOperator', () => {
